...
INSERT INTO "new_Expense" ("accountId", "amountCents", "categoryId", "createdAt", "date", "description", "id", "type") SELECT "accountId", "amountCents", "categoryId", "createdAt", "date", "description", "id", "type" FROM "Expense";
DROP TABLE "Expense";
